            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message"><a href="{{ url('/admin/dash') }}" title="返回首页"><i class="fa fa-home"></i></a>欢迎使用钢华资讯站管理系统</span>
                        </li>
                        <li class="dropdown">
                        ...
                        <li>
                            ...
                            <form method="post" action="{{ url('/admin/logout') }}">
                                ...
                                <button class="logout" type="submit"><i class="fa fa-sign-out"></i> 退出</button>
                            </form>
                        </li>
                    </ul>
